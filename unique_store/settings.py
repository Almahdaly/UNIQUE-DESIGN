"""
Django settings for unique_store project.
...
SECRET_KEY = 'django-insecure-q+l01p8k3*6jlw8ds6ge@ef^1a99jcj)%$=w5@3e%u(cky^%uk'
...
ROOT_URLCONF = 'unique_store.urls'
...
WSGI_APPLICATION = 'unique_store.wsgi.application'
